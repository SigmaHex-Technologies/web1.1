        ...
        >
          ...
          >
            ...
            >
              ...
              <Box mt={2}>
                ...
                <Link>UnityHub vs. Kickstarter</Link> <br />
          ...
          >
            ...
            <Text textAlign="center" mt={2}>
              Discover new and clever products in the UnityHub newsletter
            </Text>
            <Container>
              <Input
                borderRadius="0"
              ...
              />{" "}
              I agree to the{" "}
              <Link href="https://www.UnityHub.com/about/terms">
                <a style={{ textDecoration: "underline", color: "#E51075" }}>
                  Terms of Use
                </a>
              </Link>{" "}
              and have read and understand the{" "}
              <Link href="https://www.UnityHub.com/about/privacy">
                <a style={{ textDecoration: "underline", color: "#E51075" }}>
                  Privacy Policy
                </a>{" "}
              </Link>
        ...
        >
          ...
          >
            <Link
              ...
              href="https://www.UniyuHub.com/about/terms"
            >
              {" "}
              Terms of use
            </Link>
            <Link
              fontSize={{ base: "11px", md: "13px", lg: "13px" }}
              href="https://www.UniyuHub.com/about/privacy"
            >
              Privacy Policy
            </Link>
            <Link
              fontSize={{ base: "11px", md: "13px", lg: "13px" }}
              href="https://www.UniyuHub.com/"
            >
              Cookie Policy
            </Link>
          </Box>
          ...
          >
            ...
            <Link
              fontSize={{ base: "11px", md: "13px", lg: "13px" }}
              href="https://www.UniyuHub.com/about/accessibility"
            >
              Accessibility
            </Link>
          </Box>
          ...
          >
            @ 2023 UniyuHub.Inc.All Rights Reserved
          </Text>
        </Box>
      </Flex>
    </div>
